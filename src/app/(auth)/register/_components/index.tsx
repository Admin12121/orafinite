...
const Register = () => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative  size-full h-[610px] rounded-[20px] ring-1 ring-neutral-950 px-10 bg-neutral-950/80",
          "shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)]",
          "shadow-[0_1px_0_0_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(0,0,0,0.1),0_2px_2px_0_rgba(0,0,0,0.1),0_4px_4px_0_rgba(0,0,0,0.1),0_8px_8px_0_rgba(0,0,0,0.1)]"
        )}
      >
        ...
        <Form {...form}>
          ...
          >
            <div className="space-y-4">
              ...
              />
              <span className="relative w-full flex items-center justify-center h-[30px]">
                <Separator className="bg-neutral-800/50" />
                <h2 className="absolute left-[190px] top-0 bg-neutral-900 text-center w-[30px]">
                  or
                </h2>
              </span>
              {values.email?.toString().trim() ? (
                <Button
                  ...
                  disabled={!formValid}
                  className={cn(
                    "w-full items-center justify-center bg-neutral-950 gap-5 px-2 h-12 cursor-pointer ring-1 ring-neutral-800 ring-offset-1 ring-offset-neutral-900 disabled:opacity-50"
                  )}
                >
                  Register
                </Button>
